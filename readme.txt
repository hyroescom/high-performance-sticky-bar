...
Tags: notification bar, sticky bar, lightweight, cookie, customizable
...
A lightweight, high-performance sticky notification bar with minimal impact on page load times.

== Description ==

Lightweight High Performance Sticky Bar adds a customizable sticky notification bar to the top of your website with minimal performance impact. Perfect for announcements, promotions, or important messages that need visibility without disrupting the user experience.
...
= Configuration =
1. Navigate to Tools → Lightweight High Performance Sticky Bar in your WordPress admin
...
1. The settings page under Tools → Lightweight High Performance Sticky Bar
2. How the sticky bar appears on your website
3. Selecting a custom background color using the built-in color picker
...
= 1.4 =
This version adds the ability to configure how long the bar stays hidden after a visitor closes it, plus improvements to mobile display.
